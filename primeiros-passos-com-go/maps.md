...
Em [arrays e slices](arrays-e-slices.md), vimos como armazenar valores em ordem. Agora, vamos descobrir uma forma de armazenar itens por uma `key` \(chave\) e procurar por ela rapidamente.
